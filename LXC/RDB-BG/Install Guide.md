...
# Data locations
# Default: /root/.local/share/Red-DiscordBot/data/rdbbg01 (/root/.config/Red-DiscordBot)
/mnt/ssd1/rdb-bg-01/data/  
...
systemctl start red@rdbbg01
systemctl enable red@rdbbg01
...
[Service]
ExecStart=/root/.pyenv/versions/rdb-bg-01/bin/python -O -m redbot %I --no-prompt
User=root
Group=root
Type=idle
Restart=always
